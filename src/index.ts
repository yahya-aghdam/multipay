...
import { CreatePaymentService, GetPaymentDetailsService, VerifyPaymentService } from './protos/multipay';
import { createPayment, getPaymentDetails, verifyPayment } from './protos/multipay.service.proto';
...
server.addService(GetPaymentDetailsService, { getPaymentDetails });
